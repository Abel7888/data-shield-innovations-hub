        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-300 hover:text-datashield-blue">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-datashield-blue">Data Shield Security</a></li>
              <li><a href="#" className="text-gray-300 hover:text-datashield-blue">Data Shield Insights</a></li>
              <li><a href="#" className="text-gray-300 hover:text-datashield-blue">Data Shield PropTech</a></li>
              <li><a href="#" className="text-gray-300 hover:text-datashield-blue">Data Shield FinTech</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">123 Innovation Drive, Palo Alto, CA 94301</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 mr-2 text-datashield-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-300">info@datashield.tech</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 mr-2 text-datashield-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
